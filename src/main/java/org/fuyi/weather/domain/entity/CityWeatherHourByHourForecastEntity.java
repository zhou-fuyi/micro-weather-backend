...
public class CityWeatherHourByHourForecastEntity extends AbstractWeatherProxyWrappedEntity {
    @Override
    public String getDataColumn() {
        return WeatherProxyConstant.DataColumn.HOURLY;
    }
}
